...
def get_model_description(jsonData, modelName):
...
def get_column_description(jsonData, modelName, columnName):
...
def run():
    ...
    for relationKey in catalogJson['sources']:
        ...
        relation['metadata']['description'] = get_model_description(manifestJson, relationKey)
        for columnKey in relation['columns']:
            column = relation['columns'][columnKey]
            column['description'] = get_column_description(manifestJson, relationKey, columnKey)
