...
argParser.add_argument ('operation', 
                        choices=['build', 'build-data', 'cleanup', 'dependencies', 'refresh', 'test', 'history', 'data-health-report', 'enrich-metadata', 'definition-health-report', 'documentation', 'patch-dbt'], 
                        help='''
...
10. patch-dbt                    Patch dbt bugs, empty if the current version pair has no problems.
                                ''')
